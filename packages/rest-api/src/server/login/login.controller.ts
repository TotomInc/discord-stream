...
import { DiscordUserTokens } from '../../models/DiscordAPI';
 ...
 */
function retrieveDiscordTokens(originalReq: Request, code: string): Promise<DiscordUserTokens> {
  ...
  return axios.post<DiscordUserTokens>('https://discordapp.com/api/oauth2/token', data, { headers })
